...
<script>
document.getElementById("updateTitle").value = '<%=post.postTitle.toString()%>';
document.getElementById("updateDescription").value = '<%=post.postDescription.toString()%>';
$('#summernote').summernote('editor.pasteHTML', '<%=post.postContent.toString()%>');
</script>
